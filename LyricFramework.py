...
if __name__ == "__main__":
    ...
    _, tsneProcessed = Analysis.graphWithClustering(mc, Collection.ARTIST,
                                                         clusterMethod=Analysis.tSNE, returnVectors=True)
    Utilities.writeIterable(before, 'Vectors/Artist Vocabulary Vectors.txt')
    Utilities.writeIterable(pcaProcessed, 'Vectors/PCA-Processed Vocabulary Vectors.txt')
    Utilities.writeIterable(tsneProcessed, 'Vectors/tSNE-Processed Vocabulary Vectors.txt')
    exit(0)
